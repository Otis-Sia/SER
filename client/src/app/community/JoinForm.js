            ...
            <div className="join-declaration-box">
              <label className="join-option-label" style={{ alignItems: 'flex-start', border: 'none', background: 'transparent' }}>
                ...
                <span style={{ fontSize: '0.88rem', lineHeight: '1.5' }}>
                  <strong>Declaration &amp; Media Release:</strong> I hereby confirm that the information provided is true and accurate to the best of my knowledge. I understand that participation in Scouts Emergency Response (SER) requires adherence to safety guidelines and that my details may be used for communication, coordination, and emergency response purposes. Furthermore, I grant SER permission to capture, publish, and use photographs, videos, or audio recordings of me taken during SER activities on SER&apos;s official website, social media channels, and promotional media (with media of children strictly governed by our Child Protection Policy and parental consent). I agree to actively participate responsibly, uphold the values of SER, and abide by the <a href="/terms" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--primary-color)', textDecoration: 'underline', fontWeight: 600 }}>Terms of Service</a>, <a href="/terms#child-protection" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--primary-color)', textDecoration: 'underline', fontWeight: 600 }}>Child Protection Policy</a>, and <a href="/privacy" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--primary-color)', textDecoration: 'underline', fontWeight: 600 }}>Privacy Policy</a>. <span className="required-star">*</span>
                </span>
              </label>
            </div>
          </fieldset>
