    ...
    <div className="join-form-card">
      ...
      {status === 'success' ? (
        <div className="join-success">
          ...
          <p>
            Welcome to Scouts Emergency Response! We&apos;ve received your application. Our team will reach out to you shortly via email or WhatsApp.
          </p>
        ...
        <form onSubmit={handleSubmit} autoComplete="off">
          ...
          {/* Submit */}
          <button type="submit" className="btn join-submit-btn" disabled={status === 'submitting'}>
            {status === 'submitting' ? (
              <>
